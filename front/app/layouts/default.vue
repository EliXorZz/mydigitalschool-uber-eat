              ...
              <div class="flex flex-col gap-4 p-10">
                ...
                <div v-if="cartStore.items.length > 0">
                  <div
                    ...
                    :key="item.id"
                    class="flex items-center gap-3 bg-gray-50 px-2 pr-10 rounded-lg"
                  >
                    <img
                      :src="item.image"
                      alt=""
                    ...
                    <div class="font-bold text-primary">
                      {{ cartStore.getQuantityOfItem(item) * item.price }}€
                    </div>
                  </div>
                ...
                <div
                  v-else
                  class="mt-40 w-full flex flex-col gap-6 justify-center items-center"
                >
                  <UIcon
