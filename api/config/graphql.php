...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                App\GraphQL\Queries\RestaurantsQuery::class,
                App\GraphQL\Queries\RestaurantQuery::class,
                App\GraphQL\Queries\DishesQuery::class,
                App\GraphQL\Queries\DishQuery::class,
            ],
            'mutation' => [
                App\GraphQL\Mutations\CreateRestaurantMutation::class,
                App\GraphQL\Mutations\UpdateRestaurantMutation::class,
                App\GraphQL\Mutations\CreateDishMutation::class,
                App\GraphQL\Mutations\UpdateDishMutation::class,
            ],
            'types' => [],
    ...
    //
    'types' => [
        App\GraphQL\Types\RestaurantGqlType::class,
        App\GraphQL\Types\DishType::class,
        App\GraphQL\Types\RestaurantTypeType::class,
    ],
